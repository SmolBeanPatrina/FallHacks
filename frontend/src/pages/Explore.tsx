      ...
      <main className="flex flex-col mt-12 text-left w-screen max-w-lg p-4 gap-6">
        <div>
          ...
          <div className="overflow-x-auto w-full whitespace-nowrap mt-2">
            <Card title="Daily Meditation" desc="Let your thoughts flow and live in the moment. Take a minute to relax every day." />
            <Card title="Stay Hydrated" desc="Replenish water supply to your body periodically. Take a break from your busy life and care for your body." />
          </div>
        </div>
        <div>
